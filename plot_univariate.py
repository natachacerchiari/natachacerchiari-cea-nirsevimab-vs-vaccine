...
param_labels = {
    ...
    "low_coverage": "Equal Nirsevimab and Vaccine coverages (75%)*",
    "high_coverage": "Equal Nirsevimab and Vaccine coverages (95%)*",
    "nirsevimab_unit_cost": "Nirsevimab unit price (-25% and +25%)",
    ...
    "caregiver_salary": "Caregiver wages (+25% and -25%)",
    "n_effectiveness": "Nirsevimab effectiveness (upper CI and lower CI)",
}
...
if not df_sorted_soc.empty:
    ...
    ax2.axvline(
        ...
        linestyle="--",
        linewidth=1,
        label=f"Baseline ICER = {ref_icer_soc:,.0f} USD/DALY",
    )
